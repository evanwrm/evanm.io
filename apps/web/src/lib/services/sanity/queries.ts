...
export const articleFind = async ({ sort = "endDate desc" }: ArticleFindRequest) => {
...
export const educationFind = async ({ sort = "name desc" }: EducationFindRequest) => {
    return validatePromise(
        api(`*[_type == "education"]{
        ...,
        "slug":slug.current,
...
export const experienceFind = async ({ sort = "name desc" }: ExperienceFindRequest) => {
    return validatePromise(
...
export const projectFind = async ({ sort = "endDate desc" }: ProjectFindRequest) => {
    return validatePromise(
        api(
            `*[_type == "project"]{
            ...,
...
export const publicationFind = async ({ sort = "year desc" }: PublicationFindRequest) => {
    return validatePromise(
        api(
            `*[_type == "publication"]{
            ...,
