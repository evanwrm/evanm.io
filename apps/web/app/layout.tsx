...
import { seoFind } from "@/lib/services/sanity/queries";
...
export const generateMetadata = async (): Promise<Metadata> => {
    ...
    return {
        ...
        title: {
            ...
            template:
                seo.titleTemplate ??
                `%s | ${env.NEXT_PUBLIC_DEFAULT_SITE_TITLE}`,
        },
        ...
        openGraph: {
            ...
            siteName:
                seo.openGraph?.siteName ?? env.NEXT_PUBLIC_DEFAULT_SITE_TITLE,
            ...
            <body className="scrollbar bg-background text-foreground transition duration-150">
                <RootProvider>
                    <div vaul-drawer-wrapper="">
                        <div className="relative flex min-h-screen flex-col overflow-clip bg-background">
                            <Analytics />
                            {children}
                            <BackToTop />
                        </div>
